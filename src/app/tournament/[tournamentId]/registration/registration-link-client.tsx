...
function stateMessage(state: RegistrationLinkState) {
  ...
  if (state.status === "open") return `Active link · expires ${new Date(state.expiresAt).toLocaleString()}`;
