    ...
    <main className="shell">
      ...
      <div className="dashboard-grid">
        <section className="panel score-panel" id="score" aria-labelledby="score-title">
          <div className="panel-heading"><div><p className="eyebrow">FAST ENTRY</p><h2 id="score-title">Record game result</h2></div><span className="step">1 of 3</span></div>
