    ...
    <main className="shell">
      ...
      <div className="dashboard-grid">
        <section className="panel score-panel" id="score" aria-labelledby="score-title">
          ...
          <div className="margin-entry"><label htmlFor="margin">Spread Points</label><output id="margin" aria-live="polite" className={score ? "margin-value" : "margin-value invalid"}>{marginText || "—"}</output></div>
