-- A receipt proves a past operation, not current authority. Do not replay any
-- receipt through the application wrapper after the actor loses the current
-- director/co-director role. The underlying 0047 writer independently makes
-- the same authorization decision for every mutation.
