-- The director-facing state must never call a disabled, retired, expired, or
-- registration-closed link "open". Mutation functions still recheck this
-- state under their advisory lock.
