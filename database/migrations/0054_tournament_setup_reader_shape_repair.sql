-- Keep setup history minimal. A historical revision ID is intentionally not
-- exposed until a separately reviewed, authorized historical-detail contract exists.
