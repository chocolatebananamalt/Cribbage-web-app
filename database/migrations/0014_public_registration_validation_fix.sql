-- The pilot initially used a double-escaped regular expression in the public
-- registration function. Replace it with PostgreSQL POSIX character classes.
...
begin
  ...
  select c.request_fingerprint into v_existing_fingerprint from app.registration_claims c where c.tournament_id = v_tournament_id and c.client_operation_id = p_client_operation_id;
  if found then
