...
test("setup read decision distinguishes authorized absence from malformed or failed reads", () => {
  ...
  assert.deepEqual(decideSetupRead({ rpcFailure: false, workspace: { current: null, history: [] }, officialChoices: { directorProfileId: "123e4567-e89b-42d3-a456-426614174000", directorDisplayName: "Primary Director", coDirectorProfileIds: [] }, valid: true }), { status: 200 });
});
