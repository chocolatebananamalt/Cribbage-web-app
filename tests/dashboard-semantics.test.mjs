...
assert.match(source, /Seating Assignments and Table Plan/);
  ...
  assert.match(source, /Open Main Sample PDF/);
  assert.match(source, /const configuredEvents = \["Main", "Consy", "Canadian Doubles", "Topaz Satellite"\]/);
  assert.match(source, /Team scorecard configuration/);
  ...
  assert.match(source, /title="ACC Quick Reference"/);
  ...
  assert.match(source, /Open Full ACC Rulebook/);
