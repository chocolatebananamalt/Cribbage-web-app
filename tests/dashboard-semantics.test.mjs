...
assert.match(source, /Seating Assignments and Table Plan/);
  ...
  assert.match(source, /Satellite results record placements, payouts, Side Pools, and special hands after cross-checking/);
  assert.match(source, /Satellites do not award MRPs or qualify players or teams for Main or Consolation/);
  assert.doesNotMatch(source, /Qualification Rules Pending/);
