...
| --- | --- | --- | --- |
| Current governing rulebook | [ACC Rules page](https://www.cribbage.org/NewSite/rules/default.asp) identifies the 2025 Rulebook as the current public edition. | Record version/date and link it from the in-app reference; create dated scoring and cross-check fixtures. | In progress |
| Game-points and scorecard arithmetic | 2025 Rulebook rules 12.1–12.2 and the official scorecard templates. | Enforce normal win/loss and skunk game points, reciprocal plus/minus spread, totals, and correction recalculation. | In progress |
| Qualification order and playoff count/byes | [ACC Play-off Brackets and Byes](https://www.cribbage.org/NewSite/rules/playoffbracket.asp). | Fixture-test ranking, one-in-four qualification rounded up, and approved bye calculation. | Not started |
...
| Main, Consolation, double-elimination, doubles, and satellite event vocabulary | Current [Tournament Director Resources](https://www.cribbage.org/NewSite/sched/tournament_dir.asp), sanctioning forms, approved flyers, and the 2025 rulebook appendix where applicable. | Make the setup form list only confirmed options and label custom options as director-defined. | Not started |
