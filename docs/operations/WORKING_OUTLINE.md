...
| 5 | **Results and financials.** Standings, qualification/high-non-qualifier, playoff results, approved MRP/Q-pool calculations, expenses, fees, payouts, reconciliation, and director exports operate per event. | In progress | **Target 2026-09-17** | Paper-inclusive correction-aware standings, completion evidence, immutable qualifying-round finalization, provisional qualifiers, cutoff-tie rejection, High Non-Qualifier, and audited expenses are implemented with hosted proof. Playoff results, current MRP/Q-pool/payout schedules, reconciliation, and exports remain; affected outputs fail closed. |
