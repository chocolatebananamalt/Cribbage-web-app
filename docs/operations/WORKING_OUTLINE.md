...
| 2 | **Platform and access foundation.** Vercel Production, Supabase Auth/database, private role boundaries, audit receipts, and safe registration links operate. | Implementation and deployment complete; physical acceptance remains | **Implemented and deployed 2026-09-12; acceptance target 2026-09-16** | Production hosting, passwordless sign-in, named tournament chooser, registration link/claim/review, witnessed roster-account activation, and protected role boundaries operate. Migration 0161 and the audited Cross-checker Assignments screen are live; disposable/pilot fixtures, service-role grants, final 320/1280 browser checks, anonymous route boundaries, and runtime checks pass. A genuinely independent account/session rehearsal remains. |
...
| 6 | **Pilot release proof.** Phone/desktop/zoom, independent sessions, offline/reconnect, backup/restore, rollback, monitoring, and director rehearsal pass against the release candidate. | In progress | **Target 2026-09-18** | Automated 320/375/640/1280 rendering, full local gate, hosted rollback fixtures, Production smoke/runtime monitoring, Vercel rollback, and isolated schema reconstruction/parity pass. On 2026-09-13 the repository-owned `pnpm verify:live-demo` check operated 20 distinct production-demo screens at 320/640/1280 with zero overflow, CSP violations, failed requests, console errors, or page errors; it also parsed the seating-print and qualification-summary outputs as non-empty PDFs. Independent player/official sessions, disconnect/reconnect, a private-record backup/content restore, and the director walkthrough remain physical acceptance rehearsals in `OCTOBER_PILOT_REHEARSAL.md`. |
