...
| 2 | **Platform and access foundation.** Vercel Production, Supabase Auth/database, private role boundaries, audit receipts, and safe registration links operate. | In progress | **Target 2026-09-12** | Hosting, sign-in, the RFC-valid pilot tournament, audited director/co-director access, and migrations through 0120 are live. Production has the dedicated server-only database credential. Independent sessions and complete real pilot proof remain. |
