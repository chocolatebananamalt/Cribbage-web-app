...
| 3 | **Tournament setup, players, check-in, and initial seating.** Main/Consolation/Satellites, game counts, fees, Q-pools, roster/import, payment status, check-in, closure, table capacity, assignments, event participants, and game schedule operate under one tournament. | Implementation deployed; rehearsal remains | **Core implemented 2026-09-12; input repair deployed 2026-09-13; tournament-operations completion implemented 2026-09-14; rehearsal target 2026-09-16** | Manual/CSV/public intake, claim review/promotion, explicit paper/digital choice, per-tournament cash/check configuration, amount owed/received/remaining/status, check-in, registration freeze, dynamic table plan, printable seating, event enrollment, setup amendment, reviewed schedule publication, event start, and audited late/missing/departure schedule amendment workspace are implemented. Defined outcomes use the 2019 Manual/2025 Rulebook; mixed rotations remain a validated director choice. One actual registration-close → seating → enrollment → schedule → exception rehearsal remains. Flyer import is deferred. |
...
| 5 | **Results and financials.** Standings, qualification/high-non-qualifier, playoff results, approved MRP/Q-pool calculations, expenses, fees, payouts, reconciliation, and director exports operate per event. | Implementation and deployment complete; rehearsal remains | **Core deployed 2026-09-12; Side Pool and Satellite completion deployed 2026-09-14; acceptance target 2026-09-17** | Correction-aware standings, immutable qualification, cutoff-tie rejection, HNQ ordering, playoff placement, manual MRP/Q-pool/award entry, payment/expense snapshots, cent-conserving finalization, four event-scoped operational Side Pools, Satellite versioned result packages, private CSV/PDF exports, and twelve-month Satellite retention are live. Satellite outputs state no MRP/no Main-Consy qualification effect. Hosted rollback, PR checks, responsive Production smoke, and runtime-error gates pass; director rehearsal evidence remains. |
