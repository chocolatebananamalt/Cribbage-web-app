...
| 2 | **Platform and access foundation.** Vercel Production, Supabase Auth/database, private role boundaries, audit receipts, and safe registration links operate. | Implementation complete; acceptance proof remains | **Implemented 2026-09-12; acceptance target 2026-09-16** | Production hosting, passwordless sign-in, named tournament chooser, registration link/claim/review, audited role boundaries, migrations through 0152, rollback, and runtime-error checks pass. A genuinely independent account/session rehearsal remains. |
