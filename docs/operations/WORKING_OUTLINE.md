...
| 5 | **Results and financials.** Standings, qualification/high-non-qualifier, playoff results, approved MRP/Q-pool calculations, expenses, fees, payouts, reconciliation, and director exports operate per event. | Implementation complete on release branch; deployment/rehearsal remains | **Core deployed 2026-09-12; Side Pool and Satellite completion implemented 2026-09-14; acceptance target 2026-09-17** | Correction-aware standings, immutable qualification, cutoff-tie rejection, HNQ ordering, playoff placement, manual MRP/Q-pool/award entry, payment/expense snapshots, cent-conserving finalization, four event-scoped operational Side Pools, Satellite versioned result packages, private CSV/PDF exports, and twelve-month Satellite retention are implemented. Satellite outputs state no MRP/no Main-Consy qualification effect. Hosted rollback and local full gates pass; deployment and director rehearsal evidence remain. |
