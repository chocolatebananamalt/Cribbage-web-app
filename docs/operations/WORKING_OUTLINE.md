...
| 3 | **Tournament setup, players, check-in, seating, and directory.** Main/Consolation/Satellites, supported doubles, game counts, fees, Q-pools, roster/import, payment status, check-in, closure, capacity, assignments, scoped lookup, event participants, and schedules operate under one tournament. | Core implementation/rehearsal in progress | **Target 2026-09-18** | Preserve individual identities and team claims, captain-selected shared mode, scorer designation/linkage flag, published starting/current Table/Seat and permanent IDs, participant directory with private-field filtering, and printable paper-card lists. One actual registration-close → seating → directory → schedule rehearsal remains. |
| 4 | **Singles and supported team scoring, scorecards, cross-checking, disputes, and offline durability.** Standard Singles plus Traditional/Canadian Doubles support independent verification, reciprocal team lines, paper/hybrid paths, corrections, and durable offline replay. | Implementation and verification in progress | **Target 2026-09-18** | Team-specific records, four-member display, opposing designated-scorer confirmation, self-confirmation rejection, team standings, paper-card counts, and offline recovery must be implemented and tested without changing proven singles safeguards. Physical independent-session proof remains. |
| 5 | **Results and financials.** Standings, qualification/high-non-qualifier, playoff results, six Side Pools, approved MRP/Q-pool calculations, expenses, fees, payouts, reconciliation, and director exports operate per event. | Implementation and verification in progress | **Target 2026-09-18** | Preserve team-entry standings and both members in results/finance. Expand Side Pools from four to six with unique configurable names, equal-fee support, rejection of duplicates/seventh, dedicated event and combined tournament reports. Existing correction-aware and cent-conserving safeguards remain. |
