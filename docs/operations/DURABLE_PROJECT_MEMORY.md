...
| The October pilot may use an optional on-device camera/file preview beside paper-card transcription. The selected image stays in browser memory and is never uploaded; it remains only a visual aid for the existing two-official workflow. | Engineering implementation boundary, 2026-09-12 | This closes the camera convenience gap without inventing retention or OCR authority. Retained-image OCR remains separately gated. |
