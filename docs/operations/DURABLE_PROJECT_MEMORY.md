...
| The owner-approved disposable Supabase project and approved pilot are current through migration 0162; rollback fixtures pass on both and no synthetic paper-access rows remain. | Hosted restore and migration evidence, 2026-09-13 | Use the disposable project for isolated synthetic validation. Do not copy private pilot records into it without an approved backup/restore rehearsal and evidence-handling plan. |
