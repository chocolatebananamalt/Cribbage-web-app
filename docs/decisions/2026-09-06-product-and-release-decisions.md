...
5. **Rules:** Provide a searchable quick reference and official ACC rulebook link, preferably cached for offline use. The user recorded permission on 2026-09-07 to copy/cache the full ACC Rulebook. The app may therefore cache the dated official 2025 PDF, retain its source URL and edition metadata, and must replace it only with a later dated official asset. Each implementation rule still needs an effective date, source, and tested fixture.
